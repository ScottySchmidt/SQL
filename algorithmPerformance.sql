/* 
Algorithm Performance: https://platform.stratascratch.com/coding/10350-algorithm-performance?code_type=1: Meta/Facebook is developing a search algorithm that will allow users to search through their post history. You have been assigned to evaluate the performance of this algorithm.
